...
//icmp
 ...
 public:
    ...
    static void icmp_protocol_packet_callback(u_char* argument, const struct pcap_pkthdr* packet_header, const u_char* packet_content) {
        ...
        libpcap9::icmp_id.push_back(icmp_protocol->icmp_id_lliiuuwweennttaaoo);
...
//        adjust();
 ...
 //         for (int i=0;i<libpcap9::ip_version.size();i++) {
 //             cout<<i<<"  :ip_version: "<<libpcap9::ip_version[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::ip_header_length.size();i++) {
 //             cout<<i<<"  :ip_header_length: "<<libpcap9::ip_header_length[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::ip_tos.size();i++) {
 //             cout<<i<<"  :ip_tos: "<<libpcap9::ip_tos[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::ip_total_length.size();i++) {
 //             cout<<i<<"  :ip_total_length: "<<libpcap9::ip_total_length[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::ip_id.size();i++) {
 //             cout<<i<<"  :ip_id: "<<libpcap9::ip_id[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::ip_offset.size();i++) {
 //             cout<<i<<"  :ip_offset: "<<libpcap9::ip_offset[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::ip_ttl.size();i++) {
 //             cout<<i<<"  :ip_ttl: "<<libpcap9::ip_ttl[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::ip_protocol.size();i++) {
 //             cout<<i<<"  :ip_protocol: "<<libpcap9::ip_protocol[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::ip_checksum.size();i++) {
 //             cout<<i<<"  :ip_checksum: "<<libpcap9::ip_checksum[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::ip_source_address.size();i++) {
 //             cout<<i<<"  :ip_source_address: "<<libpcap9::ip_source_address[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::ip_des_adddress.size();i++) {
 //             cout<<i<<"  :ip_des_adddress: "<<libpcap9::ip_des_adddress[i]<<endl;
 //         }
 ...
 //        for (int i=0;i<libpcap9::tcp_source_port.size();i++) {
 //            cout<<i<<"  :tcp_source_port: "<<libpcap9::tcp_source_port[i]<<endl;
 //        }

 //        for (int i=0;i<libpcap9::tcp_des_port.size();i++) {
 //            cout<<i<<"  :tcp_des_port: "<<libpcap9::tcp_des_port[i]<<endl;
 //        }

 //        for (int i=0;i<libpcap9::tcp_protocol.size();i++) {
 //            cout<<i<<"  :tcp_protocol: "<<libpcap9::tcp_protocol[i]<<endl;
 //        }

 //        for (int i=0;i<libpcap9::tcp_seq_num.size();i++) {
 //            cout<<i<<"  :tcp_seq_num: "<<libpcap9::tcp_seq_num[i]<<endl;
 //        }

 //        for (int i=0;i<libpcap9::tcp_ack_num.size();i++) {
 //            cout<<i<<"  :tcp_ack_num: "<<libpcap9::tcp_ack_num[i]<<endl;
 //        }

 //        for (int i=0;i<libpcap9::tcp_header_length.size();i++) {
 //            cout<<i<<"  :tcp_header_length: "<<libpcap9::tcp_header_length[i]<<endl;
 //        }

 //        for (int i=0;i<libpcap9::tcp_reserved.size();i++) {
 //            cout<<i<<"  :tcp_reserved: "<<libpcap9::tcp_reserved[i]<<endl;
 //        }

 //        for (int i=0;i<libpcap9::tcp_flags.size();i++) {
 //            cout<<i<<"  :tcp_flags: "<<libpcap9::tcp_flags[i]<<endl;
 //        }

 //        for (int i=0;i<libpcap9::tcp_win_size.size();i++) {
 //            cout<<i<<"  :tcp_win_size: "<<libpcap9::tcp_win_size[i]<<endl;
 //        }

 //        for (int i=0;i<libpcap9::tcp_checksum.size();i++) {
 //            cout<<i<<"  :tcp_checksum: "<<libpcap9::tcp_checksum[i]<<endl;
 //        }

 //        for (int i=0;i<libpcap9::tcp_u_pointer.size();i++) {
 //            cout<<i<<"  :tcp_u_pointer: "<<libpcap9::tcp_u_pointer[i]<<endl;
 //        }
 ...
 //         for (int i=0;i<libpcap9::udp_source_port.size();i++) {
 //             cout<<i<<"  :udp_source_port: "<<libpcap9::udp_source_port[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::udp_des_port.size();i++) {
 //             cout<<i<<"  :udp_des_port: "<<libpcap9::udp_des_port[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::udp_service.size();i++) {
 //             cout<<i<<"  :udp_service: "<<libpcap9::udp_service[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::udp_length.size();i++) {
 //             cout<<i<<"  :udp_length: "<<libpcap9::udp_length[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::udp_checksum.size();i++) {
 //             cout<<i<<"  :udp_checksum: "<<libpcap9::udp_checksum[i]<<endl;
 //         }
 ...
 //         for (int i=0;i<libpcap9::icmp_type.size();i++) {
 //             cout<<i<<"  :icmp_type: "<<libpcap9::icmp_type[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::icmp_protocol.size();i++) {
 //             cout<<i<<"  :icmp_protocol: "<<libpcap9::icmp_protocol[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::icmp_code.size();i++) {
 //             cout<<i<<"  :icmp_code: "<<libpcap9::icmp_code[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::icmp_id.size();i++) {
 //             cout<<i<<"  :icmp_id: "<<libpcap9::icmp_id[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::icmp_seq_num.size();i++) {
 //             cout<<i<<"  :icmp_seq_num: "<<libpcap9::icmp_seq_num[i]<<endl;
 //         }

 //         for (int i=0;i<libpcap9::udp_checksum.size();i++) {
 //             cout<<i<<"  :icmp_checksum: "<<libpcap9::icmp_checksum[i]<<endl;
 //         }
